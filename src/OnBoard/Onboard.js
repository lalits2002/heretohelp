...
const Onboard_screen = (props) => {
  ...
  const panAnimStateChange = (evt) => {
    ...
    if (-evt.nativeEvent.translationX > THRESHOLD && evt.nativeEvent.state === State.END && snapX > -windowWidth * (NUM_OF_PAGES-1)) {
    ...
    } else if (evt.nativeEvent.translationX > THRESHOLD && evt.nativeEvent.state === State.END && snapX < 0) {
      setSnapX(snapX + windowWidth);
  ...
  return (
    <PanGestureHandler onGestureEvent={panAnim} onHandlerStateChange={panAnimStateChange}>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.navigation}>
            ...
            <View style={styles.progress_bar_container}>
              <View style={progress[0] ? styles.progress_bar_filled : styles.progress_bar}></View>
              <View style={progress[1] ? styles.progress_bar_filled : styles.progress_bar}></View>
              <View style={progress[2] ? styles.progress_bar_filled : styles.progress_bar}></View>
            </View>
          </View>
